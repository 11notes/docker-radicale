...
| kozea/radicale | 92MB | 1000:1000 | ❌ | amd64, arm64 |
...
* [3.7.3](https://hub.docker.com/r/11notes/radicale/tags?name=3.7.3)
* [3.7.3-unraid](https://hub.docker.com/r/11notes/radicale/tags?name=3.7.3-unraid)
* [3.7.3-nobody](https://hub.docker.com/r/11notes/radicale/tags?name=3.7.3-nobody)
...
# REGISTRIES ☁️
```
docker pull 11notes/radicale:3.7.3
docker pull ghcr.io/11notes/radicale:3.7.3
docker pull quay.io/11notes/radicale:3.7.3
```
...
*created 15.05.2026, 06:04:43 (CET)*